...
mod test {
    ...
    fn test_received_packet() {
		...
		assert_eq!(nt_data.pub_key, "Ea5pbdL9KkvKcpdkpQwiJfb8tq68Xl5T5Erihf7Zx0s=");
    ...
    fn test_process_received_packet() {
		...
		let nt_packet = "hello Ea5pbdL9KkvKcpdkpQwiJfb8tq68Xl5T5Erihf7Zx0s=  MjI0LjAuMC40 NDIyMzg= 1512275605 89 4qBNrBNA9wdMxfmUZxL9kP+X/1wFzgSeWkoN4TXs7YdkWA0VIWGqRGEe8Czw1M/gwd1xk1P6egp+deQ6STejBg==";
